<?php
    ...
    include 'includes/HTML-head.php';
                                ...
                                else if (isset($_GET['signup']) == 'success')
                                {
                                 ...
                                 $sql = "select spt_type, spt_description from categories;";
                    ...
                    <div class="col-sm-6 offset-sm-6 text-center">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="sp_id" placeholder="Username" maxlength="25">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" id="email" name="sp_email" placeholder="Email">
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="pwd">Password</label>
                            <input type="password" class="form-control" id="pwd" name="sp_password" placeholder="Password">
                          </div>
                          <div class="form-group col-md-6">
                        ...
                        <div class="form-row ">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="f-name" name="sp_fname" placeholder="First name" maxlength="35">
                              </div>
                          <div class="form-group col-md-6">
                            <label for="l-name">Last Name</label>
                            <input type="text" class="form-control" id="l-name" name="sp_lname" placeholder="Last name" maxlength="35">
                          </div>
                        </div>
                        <br>
                        ...
                        <select  class="form-control" name="currspt_type" >
                        <?php 
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="headline">Your Company Name</label>
                            <input type="text" class="form-control" id="headline" name="sp_company_name" 
                                   placeholder="Your profile headline" 
                                   maxlength="120">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bio">Your Company Description</label>
                            <textarea class="form-control" id="bio" name="sp_description" rows="6" maxlength="1000"
